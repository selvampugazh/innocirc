...
return [
	...
	"smtpsettings" => [
	"all" => "All Smtpsettings",
	"create" => "Create Smtpsetting",
	"edit" => "Edit Smtpsetting",
	"management" => "Smtpsetting Management",
	"main" => "Smtpsettings",
	],
	"languages" => [
	"all" => "All Languages",
	...
	"create" => "Create Smtp",
	"edit" => "Edit Smtp",
	"management" => "Smtp Management",
	"main" => "Smtps",
	],
	"currencymanagers" => [
	"all" => "All Currencymanagers",
	"create" => "Create Currencymanager",
	"edit" => "Edit Currencymanager",
	"management" => "Currencymanager Management",
	"main" => "Currencymanagers",
	],
	"payments" => [
	"all" => "All Payments",
	...
	"create" => "Create Seo",
	"edit" => "Edit Seo",
	"management" => "Seo Management",
	"main" => "Seos",
	],
	"blogmodels" => [
	"all" => "All Blogmodels",
	"create" => "Create Blogmodel",
	"edit" => "Edit Blogmodel",
	"management" => "Blogmodel Management",
	"main" => "Blogmodels",
	],
	"coupons" => [
	"all" => "All Coupons",
	...
	"specialities" => [
	"all" => "All Specialities",
	"create" => "Create Speciality",
	"edit" => "Edit Speciality",
	"management" => "Speciality Management",
	"main" => "Specialities",
	],
	],
	"language-picker" => [
