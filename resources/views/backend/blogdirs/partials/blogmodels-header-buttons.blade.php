<!--Action Button-->
@if( Active::checkUriPattern( 'admin/blogmodels' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.blogmodels.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.blogmodels.all' ) }}
            </a>
        </li>
        @permission( 'create-blogmodel' )
            <li>
                <a href="{{ route( 'admin.blogmodels.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.blogmodels.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
