<!--Action Button-->
@if( Active::checkUriPattern( 'admin/currencymanagers' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.currencymanagers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.currencymanagers.all' ) }}
            </a>
        </li>
        @permission( 'create-currencymanager' )
            <li>
                <a href="{{ route( 'admin.currencymanagers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.currencymanagers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
