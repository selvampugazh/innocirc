<!--Action Button-->
@if( Active::checkUriPattern( 'admin/languages' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.languages.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.languages.all' ) }}
            </a>
        </li>
        @permission( 'create-language' )
            <li>
                <a href="{{ route( 'admin.languages.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.languages.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
