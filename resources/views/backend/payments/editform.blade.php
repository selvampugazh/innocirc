<div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                {{ Form::select('account_env', ['0' => 'Test', '1' => 'Prod'], $payment->account_env,  ['class' => 'form-control box-size']) }}
            </div><!--col-lg-10-->
        </div><!--form-group-->
        <div class="form-group">
            <!-- Create Your Field Label Here -->
            ...
            <div class="col-lg-10">
                {{ Form::select('active', ['1' => 'Active', '0' => 'Inactive'], $payment->active,  ['class' => 'form-control box-size']) }}
            </div><!--col-lg-10-->
        </div><!--form-group-->
    </div><!--box-body-->
