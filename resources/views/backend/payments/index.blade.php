                ...
                <table id="payments-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('labels.backend.payments.table.gateway_name') }}</th>
                            <th>{{ trans('labels.backend.payments.table.active') }}</th>
        ...
        $(function() {
            var dataTable = $('#payments-table').dataTable({
                ...
                columns: [
                    ...
                    {data: 'gateway_name', name: '{{config('module.payments.table')}}.gateway_name'},
                    {data: 'active', name: '{{config('module.payments.table')}}.active'},
