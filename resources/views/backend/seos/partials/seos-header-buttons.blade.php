<!--Action Button-->
@if( Active::checkUriPattern( 'admin/seos' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.seos.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.seos.all' ) }}
            </a>
        </li>
        @permission( 'create-seo' )
            <li>
                <a href="{{ route( 'admin.seos.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.seos.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
