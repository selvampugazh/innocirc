<div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
                {{ Form::select('status', ['0' => 'Disabled', '1' => 'Enabled'], $smtp->status, ['class' => 'form-control box-size']) }}
            </div><!--col-lg-10-->
        </div><!--form-group-->
        <div class="form-group">
            <!-- Create Your Field Label Here -->
            ...
            <div class="col-lg-10">
                {{ Form::select('smtp_enabled', ['0' => 'Disabled', '1' => 'Enabled'], $smtp->smtp_enabled, ['class' => 'form-control box-size']) }}
            </div>
        </div><!--form-group-->
    </div><!--box-body-->
