<!--Action Button-->
@if( Active::checkUriPattern( 'admin/smtps' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.smtps.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.smtps.all' ) }}
            </a>
        </li>
        @permission( 'create-smtp' )
            <li>
                <a href="{{ route( 'admin.smtps.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.smtps.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
