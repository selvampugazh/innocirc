<!--Action Button-->
@if( Active::checkUriPattern( 'admin/specialities' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.specialities.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.specialities.all' ) }}
            </a>
        </li>
        @permission( 'create-speciality' )
            <li>
                <a href="{{ route( 'admin.specialities.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.specialities.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
